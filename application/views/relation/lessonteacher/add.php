    ...
    <div class="row">
        ...
        <div class="alert alert-primary alert-has-icon">
          ...
          <div class="alert-body">
            ...
            <ul>
              ...
              <li>Guru sudah ditambahkan, jadi anda tidak perlu menambahkan lagi. Anda hanya perlu mengedit data Mata Pelajaran Gurunya saja.</li>
            </ul>
          </div>
        </div>
      </div>
      <div class="col-lg-7">
        <div class="card card-outline card-primary">
          <div class="card-body">
            <?= form_open('relation/lessonteacher/add'); ?>
              <div class="row">
                <div class="col">
