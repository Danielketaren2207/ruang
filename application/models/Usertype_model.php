...
class Usertype_model extends CI_Model {
    ...
    protected $id = 'sha1(id_usertype)';
    protected $column_order = array('usertype_name');
    protected $column_search = array('usertype_name');
    protected $order = array('id_usertype' => 'asc');
