...
class Lessonteacher_model extends CI_Model {

	protected $table = 'tbl_lesson_teacher';
    ...
    {
        $this->db->select('a.id, b.id as id_teacher, b.name as teacher_name, GROUP_CONCAT(c.name SEPARATOR ",") as lesson');
    ...
    public function get_teacher()
    {
        ...
        $this->db->from('tbl_lesson_teacher');
    ...
    public function get_total_lesson_by_teacher($id_teacher)
    {
        $this->db->select('*');
        $this->db->from('tbl_lesson_teacher');
...
/* End of file Lessonteacher_model.php */
/* Location: ./application/models/Lessonteacher_model.php */